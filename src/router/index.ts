  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import(/* webpackChunkName: 'resourceCategory' */ '@/views/resource/category.vue')
      },
      {
        path: 'course',
        name: 'course',
      ...
      {
        path: 'course/:courseId/:sectionId/:lessonId/video',
        name: 'course-video',
...
router.beforeEach((to, from, next) => {
  if (to.path.startsWith('/front') || to.path.startsWith('/boss')) {
    // API 接口直接放行
    next()
